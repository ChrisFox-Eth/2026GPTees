...
export default function Hero(): JSX.Element {
  return (
    <section className="pb-12 md:py-20 text-center">
      {/* Main Headline */}
      ...
      <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
        Describe the shirt you have always wanted—gift, inside joke, band-that-doesn’t-exist—and we turn it into a soft, print-ready GPTee. You approve it before we ship.
      </p>
