 ...
 * @description Features section highlighting platform capabilities
 * @since 2025-11-21
 */
...
export default function Features(): JSX.Element {
  const features = [
    ...
    },
    {
      ...
      description: 'Generate a preview immediately, keep your prompt safe, and pay only after you approve.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 13V7a2 2 0 00-2-2h-2l-2-2H8L6 5H4a2 2 0 00-2 2v6a2 2 0 002 2h14a2 2 0 002-2z" />
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 13l3.38-3.38a2 2 0 012.829 0L12 12.414l1.293-1.293a2 2 0 012.828 0L21 15" />
        </svg>
      ),
    },
    {
      title: 'Premium Quality',
      description: 'High-quality, comfortable fabrics printed with professional-grade equipment. Your design will look amazing and last.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Secure & Easy',
      description: 'Safe payment processing, email confirmations, and order tracking. Your data is protected with enterprise-grade security.',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
