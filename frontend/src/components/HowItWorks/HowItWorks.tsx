...
export default function HowItWorks(): JSX.Element {
  const steps = [
    ...
    },
    {
      ...
      description: 'Tell our AI what you want. Be creative! From "cyberpunk cat warrior" to "minimalist mountain sunset".',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'DALL-E 3 generates your unique design in seconds. Choose from multiple styles and regenerate until it\'s perfect.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
