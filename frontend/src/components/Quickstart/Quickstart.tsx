    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 p-5 sm:p-6 flex flex-col sm:flex-row gap-4 items-start">
      <div className="flex-1 space-y-2">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          We preselected our soft black GPTee ({defaultSize}). Tell us what to print; we handle the art and printing with unlimited redraws until you say yes.
        </p>
      ...
      <div className="w-full sm:w-64 flex-shrink-0 space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 dark:text-gray-400">
                {defaultColor} - {defaultSize} - Limitless redraws
              </p>
            </div>
          </div>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
          You will pay, then generate and approve your design.
        </p>
      </div>
    </div>
  );
