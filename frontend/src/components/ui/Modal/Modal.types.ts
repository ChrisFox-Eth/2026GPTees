 ...
 * @property {() => void} [onClose] - Callback when the modal should close (optional)
 * @property {string} [title] - Optional title text to display in the modal header (optional)
 * @property {React.ReactNode} [footer] - Optional footer content (e.g., action buttons) (optional)
